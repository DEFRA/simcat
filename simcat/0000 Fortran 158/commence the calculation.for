...
*     ==========================================================================
*     File: commence the calculation.for ... 4880 lines ------------------------
*     Written in FORTRAN.  With the screen displays in VISUAL BASIC ...
*     ==========================================================================
*     Version 158  (15/11/23) --------------------------------------------------
*     ==========================================================================
...
*     gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
*     ..23   RUN158.TMP (names of files passed to SIMCAT)                   .TMP
*     ==========================================================================
...
*     batch mode ... and initialise total loads and total flows ----------------
      ...
      write( *,9045)
 9045 format(//4x,'STARTING 158'///20x,'STARTING 158'///
     &36x,'STARTING 158'///52x,'STARTING 158'///68x,'STARTING 158'///
     &84x,'STARTING 158'///100x,'STARTING 158'///)     
...
*     CSV output on apportionment of load from discharges +++++++++++++++ Pi.CSV
      do idet = 1, ndet ! loop on determinands ++++++++++++++++++++++++++ Pi.CSV
      if ( qtype (idet) .ne. 4 .and. ical .ne. 1 ) then ! +++++++++++++++ Pi.CSV
...
*     CSV output on loads from discharges (Pi.CSV) ++++++++++++++++++++++ Pi.CSV
 ...
 6828 format(',,,,','Data:,','Mean river load,',4000(a20,',')) ! -------- Pi.CSV 
      ...
      endif ! if ( qtype (idet) .ne. 4 ) ================================ Pi.CSV
      enddo ! do idet = 1, ndet ========================================= Pi.CSV
*     +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Pi.CSV
...
*    &'  V: contribution to mean, total discharge load'/ !
...
*     return to seek a new DAT file for the next model in batch mode -----------
 ...
 7199 write( *,7973)
      ...
      write(09,7973)
      write(33,7973)
 7973 format(/77('-')/'*** Error in reading RUN158.TMP ...'/77('-'))
      call stop
...
*     file for output on for determinands Di.CSV for this data file ++++ 111,112
 ...
 8755 format('SIMCAT',',','Version 158  ',',', ! ------------------------ Di.CSV
     ...
     &' % total disch load') 
*    &'disch load, lower conf, upper conf,', 
*    &' % of river conc,disch river conc, lower conf, upper conf,',
*    &' length of u/s river')  
...
*     files for effluent csv output .CSV for this data file ++++++++ 131,132,etc
 ...
 8255 format('SIMCAT',',','Version 158  ',',', ! Ei.CSV ++++++++++++ 131,132,etc
...
!5899 format('"',a70,'","Data file ..."',',"Part of batch run ..."')
 ...
 4972 format(77('-'))
      ...
      write(150+ic,2963)bday,bmon,IYEAR,BH,bmin ! ----------------+++++++ Ai.EFF
      write(150+ic,4972) ! ---------------------------------------+++++++ Ai.EFF          
...
*     prepare to compute the time taken for the run ----------------------------
 ...
 1063 format(77('-')/ ! heading 222222222222222222222222222222222222222222222222
     ...
     &'Date: ',a2,'/',a2,'/',I4/'Version 158  ', ! 22222222222222222222222222222
