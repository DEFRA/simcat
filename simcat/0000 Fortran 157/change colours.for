...
*     ==========================================================================
*     File: change colours.FOR ... 177 lines (11 lines of comments) ------------
*     --------------------------------------------------------------------------
*     This file deals with ways of changing colours of text sent to the black --
*     screen -------------------------------------------------------------------
*     --------------------------------------------------------------------------
*     This file contains 3 sub-routines ----------------------------------------
*     They are called:
*     --------------------------------------------------------------------------
*     ...... initialise QUICKWIN
*     ...... change colour of text(Lcolour)
*     ...... write colour of text
*     --------------------------------------------------------------------------
...
*     call clearscreen ($GCLEARSCREEN)
      ...
      i4=settextcolorrgb(#00FF00) ! green (10)
      endif
      ...
      write(*,*)'colour 19 light pink'
      call change colour of text (12)      
      write(*,*)'colour 12 orange'
