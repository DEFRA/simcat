...
*     ==========================================================================
*     File: meet the mean river targets ... 1564 lines -------------------------
*     --------------------------------------------------------------------------
...
*     dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
 ...
 7705 format(/110('=')/'Assess the effluent quality needed ', ! ------------ EFF
     &'to achieve the river target for ',A11/ ! --------------------------------
     &'The target is a mean of: ',a10,1x,a4,' (dissolved)'/110('-')) ! ---------
      endif ! if ( detype(JP) .eq. 909 ) === target is dissolved not total =====
*     dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
...
*     tttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
 ...
 7745 format(/110('=')/'Assess the effluent quality needed ', ! ------------ EFF
     &'to achieve the river target for ',A11/ ! --------------------------------
...
*     write out the details for determinands -----------------------------------
 ...
 7503 format(' ',a40,',',a40,',',a16,',',
     ...
     &rname(ireach),dname(JP),targit,JT(KFEAT),MRQS(JP)
...
*     the target with current effluent quality ------------------------------DET
      if ( ICAL .ne. 08 .and. ICAL .ne. 09 ) return !------------------------DET
...
*     upstream quality is set within the target upstream class 99999999999999999
      ...
      if ( RCM .gt. RCXX ) then ! check need to replace upstream river quality
      ...
      write(01,3000)SET1,RCM,RCS ! ----------------------------------------- OUT
...
*     99999999999999999999999999999999999999999999999999999999999999999999999999
      ...
      write(31,3964)valchars10,UNITS(JP),valchars11, ! --------------------- EFF
     &UNITS(JP)
...
*     78787878787878787878787878787878787878787878787878787878787878787878787878
      ...
      write(31,3963)valchars10,UNITS(JP),valchars11, ! --------------------- EFF
     &UNITS(JP)
...
*     78787878787878787878787878787878787878787878787878787878787878787878787878
      ...
      write(130+JP,7500)GIScode(feeture),unamex, ! ---------------------- Ei.CSV
...
*     88888888888888888888888888888888888888888888888888888888888888888888888888
      if ( ical .eq. 08 .or. classobj .eq. 0 ) then ! -------------------- 88888
      write(01,892) ! ------------------------------------------------------ OUT
      write(31,892) ! ------------------------------------------------------ EFF
...
*     check whether calculated discharge quality is infeasibly bad bbbbbbbbbbbbb
 ...
 8763 format(110('-')/'The calculated discharge quality is bigger ', ! bbbbbbbbbb  
     ...
     &int(TECM),units(JP),uname(feeture) ! 
      ...
      XECM(JP) = TECM
      kdecision(JP) = 8 ! target not met - retained current discharge quality --
      IMPOZZ = 77 ! impossible to meet target - retained current - no "good" ---

      goto 9095 ! calculations complete  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
*     for a mean river quality standard ---------------------------------------- 
     ...
     &(95.0,iqdist,TECM,TECS,TECX,qualnuse,testql,testqu)
      ...
      if ( iter .eq. 61 ) then ! ===============================================
      write(01,8963)valchars10,UNITS(JP),valchars11,UNITS(JP), ! ----------- OUT
     &SET1 ! --------------------------------------------------------------- OUT
      write(31,8963)valchars10,UNITS(JP),valchars11,UNITS(JP), ! ----------- EFF
     &SET1 ! --------------------------------------------------------------- EFF
 8963 format('TARGET river quality:',12x,'Mean =',a10,1x,A4,2x,
     &' Current discharge quality:'6x'Mean =',a10,1x,A4,4x,a13)
      else ! if ( iter .eq. 61 ) ie not equal to 61
      write(01,4963)valchars10,UNITS(JP),valchars11,UNITS(JP), ! ----------- OUT
     &SET1
      write(31,4963)valchars10,UNITS(JP),valchars11, ! --------------------- EFF
     &UNITS(JP),SET1
 4963 format(
     &'TARGET river quality:',12x,'Mean =',a10,1x,A4,2x,
 ...
 5963 format('Achieved river quality:',10x,'Mean =',a10,1x,A4,2x,
     &14x,'Discharge 95-percentile =',a10,1x,A4,4x,a13/110('='))
      ...
      else ! if ( ical .ne. 09 ) ie ical equals 09 =============================
 ...
 7515 format(' ',a40,',',a40,',',a16,',',
     ...
     &',',a11,1(',,,',1pe12.4),2(',',i4),',402') ! ---------------------- Ei.CSV
      ...
      icurrent = 0 ! initialise current quality as not being retained
...
*     check whether effluent quality is better than best possible --------------
      ...
      if ( TECM .ge. BEQ(1,JP) ) then ! ! calulated quality worse than "best" --
      goto 1633 
