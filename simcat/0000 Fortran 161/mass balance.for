...
*     ==========================================================================
*     --------------------------------------------------------------------------
*     File: mass balance.for ... 2629 lines ------------------------------------
*     --------------------------------------------------------------------------
...
*     assess loads contributing to percentiles 3333 apportionment of percentiles 
     ...
     &     JT(feeture) .eq. 60 .or. JT(feeture) .eq. 61) then ! 3333333333333333
      ...
      TELODEshots(kountworks,JP,IS) = Creg(3,is) * Creg(4,is) ! store loads 3333
...
*     compute percentile of effluent quality -----------------------------------
      ...
      !call sort format 3 (ECM,ECS,ECX)
      !write(150+JP,8274)DNAME(JP),valchars10,UNITS(JP),valchars11, ! ---- Di EFF
      !&UNITS(JP),valchars12,UNITS(JP) ! ---------------------------------- Di EFF
 8274 format(/77('e')/'in get effluent 95 percentiles ... ECM and ECS'/
     &77('~')/a11,37X,' Annual mean =',a10,1x,A4/
     &42X,'Standard deviation =',a10,1x,A4/
     &42X,'     95-percentile =',a10,1x,A4/77('e'))
