...
*     ==========================================================================
*     File: set up data.FOR ... 2124 lines -------------------------------------
*     --------------------------------------------------------------------------
...
*     arrays for storing data for the end of a reach ---------------------------
      ...
      TGLODE3  (IR,JP,J1) = 0.0 ! ========================================== 158
      TRLODE3  (IR,JP,J1) = 0.0
      TELODE3  (IR,JP,J1) = 0.0
      ...
      T58LOAD3 (IR,JP,J1) = 0.0 ! ========================================== 158

      enddo ! do J1 = 1, N13
      do iworks = 1, NUED ! ================================================ 158
      TELOADAVrch(iworks,IR,JP) = 0.0
      enddo ! do iworks = 1, NUED ! ======================================== 158
