...
*     ==========================================================================
*     File: process a feature.for ... 6084 lines  ------------------------------
*     --------------------------------------------------------------------------
...
*     store the monthly loads (j13) from upstream sub-catchments ---------------
      twloads(kount bodies,jp,j13) = LMcontrib(NTD,jp,1) ! ----------------- 158
...
*     ==========================================================================
      ...
      call accumulate the loads ! after River Needs discharge Standards ==== 158
...
*     mass balance: treating "concentration" as load ----------------- fish farm  
     ...
     &(fupmx,usCMcont01,QUALNB(JP,01),EFM,ECM,xnum,IQDIST,6) ! total discharges
      ...
      ELOAD62(JP,I13) = xxxfarm ! --- load from a fish farm ---------------- 158
      TELODE2(JP,I13) = TELODE2(JP,I13) + xxxfarm ! total discharge loads -- 158
      T62LOAD2(JP,i13) = T62LOAD2(JP,i13) + xxxfarm ! total for fish farms-- 158 
      TELOADAV(kountworks,JP) = xxxfarm ! --- load from a fish farm -------- 158
