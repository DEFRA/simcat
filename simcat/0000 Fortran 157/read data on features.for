...
*     ==========================================================================
*     Version 157  (15/03/18) --------------------------------------------------
*     ==========================================================================
*     File read data on features.for ... 2865 lines ----------------------------
*     --------------------------------------------------------------------------
...
*     end of data reached ----------------------------------------------------
      ...
      if ( ical13 .eq. 0 ) then
      do j = 1,ndet
      if ( QTYPE (j) .ne. 4) write(230+j,252)feetcount ! -------------- Gi.CSV
...
*     gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
     ...
     &     IT .eq. 42 .or. IT .eq. 60 .or. IT .eq. 61 ) then
...
*     check for a legal Code for the River Quality Dataset ---------------------
     ...
     &     IT .ne. 42 .and. IT .ne. 60 .and. IT .ne. 61 ) then
...
*     flows are mean and standdeviation not and 95-percentile low flow ---------
 ...
 5867 format(77('-')/
     &'*** No effluent flow dataset specified for an ',
     &'Abstraction Point '/
     &'*** Feature type 19 -      '/
     &'*** The name of the feature is: ',A33/77('-'))
      endif
