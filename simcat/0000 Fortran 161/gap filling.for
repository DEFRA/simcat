...
*     ==========================================================================
*     File Name: GAP FILL CREATION.FOR ... 4085 lines
*     ==========================================================================
...
*     ********************************************************************** 160
      do iworks = 1, kountworks ! --- remove load from upstream discharges works
      oldTE = TELODEshots(iworks,JP,is) ! current load from a works ------------
      TELODEshots(iworks,JP,is) = ! update for a loss of flow from gap filling -
     &TELODEshots(iworks,JP,is) * FMS(IS) / FOLD ! RRRRRRRRRRRRRRRRRRRRRRRRRRRRR
      enddo ! do iworks = 1, kountworks ----RRRRRRRR--=-- remove load from works
*     ********************************************************************** 160
...
*     ##########################################################################      
 1088 continue ! trim the annual loads from individual works -------------------
      ...
      xxxp = TELODEshots(iworks,JP,is)
      if ( CMS(JP,IS)/old CMS .lt. 1.0 ) then
      TELODEshots(iworks,JP,is) =
     &TELODEshots(iworks,JP,is) * CMS(JP,IS) / old CMS ! 333333333
      endif
