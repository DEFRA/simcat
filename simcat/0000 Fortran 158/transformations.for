...
*     trim loads from individual works =========================================
      ...
      TELOADAV(iworks,kprune det) = ! prune the load ! ===================== 158
     &TELOADAV(iworks,kprune det) * prune load (i13) ! ===================== 158
...
*     net loads from all discharges (3 12 5 and 39) ---------------------TELODE2
     ...
     &                        * prune load (J1)
      ...
      if ( T62LOAD2(kprune det,J1) .gt. 0.0 ) then
      T62LOAD2(kprune det,J1) = T62LOAD2(kprune det,J1)
     &                        * prune load (J1)
      endif
...
*     prune load introduced by Gap Filling for river flows ----------------- 158 
      if ( TILOADUP2(kprune det,J1) .gt. 0.0 ) then
      TILOADUP2(kprune det,J1) = TILOADUP2(kprune det,J1) ! ---------------- 158
     &                         * prune load (J1)
      endif ! if ( TILOADUP2(kprune det,J1)
*     prune load introduced by Gap Filling for river quality -------------------
      if ( TALOADUP2(kprune det,J1) .gt. 0.0 ) then
