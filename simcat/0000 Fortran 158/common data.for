...
*     ==========================================================================
*     File: common data.for ... 474 lines 
*     --------------------------------------------------------------------------
...
*     --------------------------------------------------------------------------
      ...
      parameter (NU = 19999 ) ! maximum number of features ----------------- 158
      ...
      parameter (NUED = 1700) ! number of discharges for back-tracking ----- 158
...
*     gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
      ...
      common /L9/
     &ELOAD03  (MP10,13), ELOAD05 (MP10,13), ELOAD12 (MP10,13),
     &ELOAD39  (MP10,13),
     &ELOAD60  (MP10,13), ELOAD61 (MP10,13), ELOAD62 (MP10,13)

*     total loads                                               ... TGLODE1
*     total load introduced upstream boundaries and tributaries ... TRLODE1
*     total load from discharges (3 12 5 39 60 61 62)           ... TELODE1
*     total load introduced by clean diffuse sources            ... TDDLOAD1
*     net loads                                                 ... TGLODE2
*     net load from discharges (3 12 5 39 60 61 62)             ... TELODE2
...
*     ====================================================================== 158
     ...
     &TLOSSES2  (MP10,13), TLOSSES1  (MP10,13),
...
*     ====================================================================== 158
      ...
      common /l3a4/ ! ====================================================== 158
     &TGLODE3   (MR,MP10,13), TELODE3   (MR,MP10,13),
     &TRLODE3   (MR,MP10,13), TDDLOAD3  (MR,MP10,13),
     &TALOADUP3 (MR,MP10,13), TALOADDN3 (MR,MP10,13),
     &TILOADUP3 (MR,MP10,13), 
     &TILOADDN3 (MR,MP10,13),
...
*     ====================================================================== 158
      ...
      common /l3a5/ ! ====================================================== 158
     &TGLODE4   (MR,MP10,13), TELODE4   (MR,MP10,13),
     &TRLODE4   (MR,MP10,13), TDDLOAD4  (MR,MP10,13),
     ...
     &T62LOAD1 (MP10,13),    T62LOAD2 (MP10,13),    
     ...
     &T62LOAD3 (MR,MP10,13), T62LOAD4 (MR,MP10,13)
*     ====================================================================== 158
      
      common /l4y/ mark works,kountworks,need works,kill works, ! ========== 158
     &identify werks(NUED)
