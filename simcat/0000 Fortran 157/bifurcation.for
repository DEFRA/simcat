...
*     ==========================================================================
*     File bifurcation.for ... 1155 lines --------------------------------------
*     --------------------------------------------------------------------------
...
*     set the starting values of the loads at the head of the new reach --------
      ...
      do J1 = 1, nx ! ----------------------------------------------------------     
*     7777777777777777777777777777777777777777777777777777777777777777777777-157
      TGLODE2 (JPL,J1) = TGLODE3 (ISTOR,JPL,J1) ! -- ISTOR: reach supplying flow    
      TRLODE2 (JPL,J1) = TRLOAD3 (ISTOR,JPL,J1) ! -- from boundaries and streams
      ...
      TRLODE1 (JPL,J1) = TRLOAD4 (ISTOR,JPL,J1) !  set loads at the head of new reach   
      TELODE1 (JPL,J1) = TELOAD4 (ISTOR,JPL,J1) !  set loads at the head of new reach
...
*     77777777777777777777777777777777777777777777777777777777777777777777777777
      ...
      TBLOAD2 (JPL,J1) = TBLOAD3 (ISTOR,JPL,J1) ! load removed by abstractions -
      TBLOAD1 (JPL,J1) = TBLOAD4 (ISTOR,JPL,J1) ! load removed by abstractions -   
      enddo ! do J1 = 1, nx ----------------------------------------------------
*     --------------------------------------------------------------------------      
...
*     77777777777777777777777777777777777777777777777777777777777777777777777777
      ...
      TELOADshots(iworks,JPL,is) = TELOADrchshots(iworks,ISTOR,is) ! 33333333333
...
*     eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
      ...
      call generate log normal birfurcation ! log normal effluent         
      endif ! effluent type ====================================================
*     eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
*     set the diverted flow ... make sure it is less than what is available ----
      FMS(IS) = amin1 (EF,Y(IS)) ! the flow is the diverted flow ---------------
...
*     set the starting values of the loads at the head of the new reach --------
      ...
      TRLODE2 (JPL,J1) = frat * TRLODE2 (JPL,J1) ! from boundaries and streams 
      ...
      T60LOAD2 (JPL,J1) = frat * T60LOAD2 (JPL,J1) 
      T61LOAD2 (JPL,J1) = frat * T61LOAD2 (JPL,J1) 
      ...
      T50LOAD2 (JPL,J1) = frat * T50LOAD2 (JPL,J1)   
      T52LOAD2 (JPL,J1) = frat * T52LOAD2 (JPL,J1)   
      T54LOAD2 (JPL,J1) = frat * T54LOAD2 (JPL,J1)   
      T56LOAD2 (JPL,J1) = frat * T56LOAD2 (JPL,J1)   
      T58LOAD2 (JPL,J1) = frat * T58LOAD2 (JPL,J1)   
      ...
      T60LOAD1 (JPL,J1) = frat * T60LOAD1 (JPL,J1)
      T61LOAD1 (JPL,J1) = frat * T61LOAD1 (JPL,J1)
      ...
      T50LOAD1 (JPL,J1) = frat * T50LOAD1 (JPL,J1)   
      T52LOAD1 (JPL,J1) = frat * T52LOAD1 (JPL,J1)   
      T54LOAD1 (JPL,J1) = frat * T54LOAD1 (JPL,J1)   
      T56LOAD1 (JPL,J1) = frat * T56LOAD1 (JPL,J1) 
      T58LOAD1 (JPL,J1) = frat * T58LOAD1 (JPL,J1) 
...
*     monthly loads from upstream sub-catchments -------------------------------
      ...
      do ip = 1, nprop ! loop on contributions ---------------------------------
...
*     7777777777777777777777777777777777777777777777777777777777777777777777-158     
      ...
      TRLODE2 (JPL,J1) = TRLOAD3 (ISTOR,JPL,J1) ! from boundaries and streams  
*     net loads from discharges (3 12 5 and 39 and 60 and 61) -----------TELODE2
      TELODE2 (JPL,J1) = TELOAD3 (ISTOR,JPL,J1)   
      T03LOAD2 (JPL,J1) = T03LOAD3 (ISTOR,JPL,J1)   
      T05LOAD2 (JPL,J1) = T05LOAD3 (ISTOR,JPL,J1)   
      T12LOAD2 (JPL,J1) = T12LOAD3 (ISTOR,JPL,J1)   
