...
*     ==========================================================================
*     File: process the selected reach.for ... 1579 lines ----------------------
*     --------------------------------------------------------------------------
...
*     store the annual loads discharged by upstream effluents ------------------
      TELOADAV(iw,idet) = TELOADAVrch(iw,ISTOR1,idet) ! .................... 158
     &                  + TELOADAVrch(iw,ISTOR2,idet) ! .................... 158
...
*     158 ################################################################## 158    
      ...
      TRLODE2 (JP,J1) = TRLODE3 (ISTOR1,JP,J1) + TRLODE3 (ISTOR2,JP,J1)
      TELODE2 (JP,J1) = TELODE3 (ISTOR1,JP,J1) + TELODE3 (ISTOR2,JP,J1)
     ...
     &                 + T61LOAD3 (ISTOR2,JP,J1)
      T62LOAD2 (JP,J1) = T62LOAD3 (ISTOR1,JP,J1)    
     &                 + T62LOAD3 (ISTOR2,JP,J1)
     ...
     &                 + T61LOAD4 (ISTOR2,JP,J1)
      T62LOAD1 (JP,J1) = T62LOAD4 (ISTOR1,JP,J1)    
     &                 + T62LOAD4 (ISTOR2,JP,J1)
     ...
     &                  + TGLODE4   (ISTOR2,JP,J1)
      TRLODE1   (JP,J1) = TRLODE4   (ISTOR1,JP,J1)      
     &                  + TRLODE4   (ISTOR2,JP,J1)
      TELODE1   (JP,J1) = TELODE4   (ISTOR1,JP,J1)      
     &                  + TELODE4   (ISTOR2,JP,J1)
...
*     check whether this next Feature is a river boundary ----------------------
     ...
     &     KTYPE .eq. 23 .or. KTYPE .eq. 45 ) then
      ...
      T62LOAD2 (idet,J1) = 0.0 ! net total loads from discharges (62)
